...
[![Tests](https://img.shields.io/badge/tests-741%20(734%20passed)-brightgreen)](tests/)
...
Tests use SQLite in-memory — no PostgreSQL required. **741 tests** across 45 test files covering:
...
| Testing | pytest-asyncio (741 tests) |

...
[![Tests](https://img.shields.io/badge/tests-727%20(720%20passed)-brightgreen)](tests/)
...
Tests use SQLite in-memory — no PostgreSQL required. **727 tests** across 43 test files covering:
...
| Testing | pytest-asyncio (727 tests) |

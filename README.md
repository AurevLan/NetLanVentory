...
[![Tests](https://img.shields.io/badge/tests-731%20(724%20passed)-brightgreen)](tests/)
...
Tests use SQLite in-memory — no PostgreSQL required. **731 tests** across 44 test files covering:
...
| Testing | pytest-asyncio (731 tests) |

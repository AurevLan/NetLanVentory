...
[![Tests](https://img.shields.io/badge/tests-725%20(718%20passed)-brightgreen)](tests/)
...
Tests use SQLite in-memory — no PostgreSQL required. **725 tests** across 42 test files covering:
...
| Testing | pytest-asyncio (725 tests) |

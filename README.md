...
[![Tests](https://img.shields.io/badge/tests-615%20(608%20passed)-brightgreen)](tests/)
...
Tests use SQLite in-memory — no PostgreSQL required. **615 tests** across 39 test files covering:
...
| Testing | pytest-asyncio (615 tests) |
